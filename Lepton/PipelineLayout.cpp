...
Result PipelineLayout::Create(VkDevice hDevice, vk::ArrayProxy<DescriptorSetLayout> pDescriptorSetLayouts, vk::ArrayProxy<PushConstantRange> pPushConstantRanges)
{
