...
int main()
{
	...
	Lava::Instance				instance;
	instance.Create(pExtensions, pLayers);

	Lava::PhysicalDevice * pPhysicalDevice = instance.GetPhysicalDevices()[0];
	Lava::LogicalDevice * pLogicalDevice = pPhysicalDevice->CreateLogicalDevice();
